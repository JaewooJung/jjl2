...
<label>멤버권한</label>
<select name="level">
<%if(memberUpdate.getLevel() == 0){%><option value="0" selected>일반회원</option><%} %>
<%if(memberUpdate.getLevel() == 1){%><option value="1" selected>관리자</option><%} %>
<%if(memberUpdate.getLevel() == 2){%><option value="2" selected>PM</option><%} %>
<%if(memberUpdate.getLevel() == 9){%><option value="9" selected>손님</option><%} %>
</select><br>
<br>
