...
<label>제목</label>
<input type="text" name="title" value="${projectUpdate.title}"><br>
<label>내용</label>
<input type="text" name="content" value="${projectUpdate.content}"><br>
<label>시작일</label>
<input type="text" name="startdate" value="${projectUpdate.startDate}"><br>
<label>종료일</label>
<input type="text" name="enddate" value="${projectUpdate.endDate}"><br>
<label>TAG</label>
